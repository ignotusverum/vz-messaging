...
- (instancetype)init
{
    ...
    if (self) {
        ...
        JSQMessagesAvatarImage * userImage = [JSQMessagesAvatarImageFactory avatarImageWithImage:[UIImage imageNamed:@"Concierge_Icon"]
                                                                                       diameter:kJSQMessagesCollectionViewAvatarSizeDefault];
        
        self.avatars = @{ kJSQDemoAvatarIdSquires : jobsImage,
                          kJSQDemoAvatarIdJobs : userImage
                          };
